...
# Set hostname
sudo scutil --set ComputerName "HG"
sudo scutil --set HostName "HG"
sudo scutil --set LocalHostName "HG"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "HG"
